...
public class BallNew extends Model3D
{
  ...
  public boolean colidesWith(BallNew b) {
    float distance2 = (this.m_nX - b.m_nX)*(this.m_nX - b.m_nX) + (this.m_nY - b.m_nY)*(this.m_nY - b.m_nY) + (this.m_nZ - b.m_nZ)*(this.m_nZ - b.m_nZ);
    if (distance2 <= this.radius*this.radius+b.radius*b.radius+0.1)
      return true;
    return false;
  }
