...
public class OutlinedRefactored extends BaseWindow 
{

  float posX = 0, posY = 0, posZ = 0, rotX = 0, rotY = 0, scale = 1;
  
  OutlinedPyramid m_pUser, m_pUser2;
  ...
  {
    m_pUser = new OutlinedPyramid();
    m_pUser2 = new  OutlinedPyramid();
  }
  /**
  ...
  protected void renderFrame()
  {
    ...
    m_pUser.setWire(false);
    m_pUser.render3D();
    m_pUser2.setWire(false);
    m_pUser2.render3D();
    ...
    m_pUser.setWire(true);
    m_pUser.render3D();
    m_pUser2.setWire(true);
    m_pUser2.render3D();
  ...
  public static void main(String[] args) {
    (new OutlinedRefactored()).execute();
  }  
}
