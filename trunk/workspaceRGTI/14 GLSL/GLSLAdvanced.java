...
//    GL11.glLight(GL11.GL_LIGHT1, GL11.GL_POSITION, allocFloats(new float[] { 0f, -2f, 1.0f, 0f}));
//    GL11.glLight(GL11.GL_LIGHT1, GL11.GL_AMBIENT, allocFloats(new float[] { 0.0f, 0.0f, 0.0f, 0.1f}));
//    GL11.glLight(GL11.GL_LIGHT1, GL11.GL_DIFFUSE , allocFloats(new float[] { 1.0f, 1.0f, 1.0f, 1.0f}));      
//    GL11.glLight( GL11.GL_LIGHT1, GL11.GL_SPECULAR, allocFloats(new float[] { 1.0f, 1.0f, 1.0f, 1.0f}) );    
//    
...
//    GL11.glLightf( GL11.GL_LIGHT1, GL11.GL_QUADRATIC_ATTENUATION , 0.0002f );
    
    // Loading shaders from files
    String vertShaderSrc = "";
    String fragShaderSrc = "";
    try {
//      Buffer edReader br = new BufferedReader(new FileReader("id.vert"));
