...
public class Shading extends Refactored 
{
 ...
 // select modulate to mix texture with color for shading; GL_REPLACE, GL_MODULATE ...
  ...
  protected void initializeModels()
  {
    ...
    m_Textures= Texture.loadTextures2D(new String[] { "checker2.jpg", "ceiling.jpg" });    
  } 
  ...
  {  
    ...
    GL11.glMaterial(GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE, allocFloats(new float[] { 1.0f, 1.0f, 0.5f, 0.8f}));
    // choose first texture
    GL11.glBindTexture(GL11.GL_TEXTURE_2D, m_Textures.get(0));    
    m_Obj.render3D();
    
    m_Obj.setPosition(2f, 2f, -0.5f);
