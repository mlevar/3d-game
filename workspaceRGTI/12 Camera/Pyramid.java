...
public class Pyramid extends Model3D
{
  ...
  private void renderModel()
  {
    ...
    GL11.glVertex3f(-1.0f, -0.5f, -1.0f);    // lower left vertex
    GL11.glVertex3f( 0.0f,  0.5f, -1.0f);    // upper vertex
    GL11.glVertex3f( 1.0f, -0.5f, -1.0f);    // lower right vertex
    ...
    GL11.glVertex3f( 1.0f, -0.5f, -1.0f);    // lower right vertex
    GL11.glColor3f(0, 0, 1);
    GL11.glVertex3f( 0.0f,  -0.5f, 0.0f);    // lower front vertex
