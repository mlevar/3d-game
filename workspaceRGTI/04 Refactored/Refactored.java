...
public class Refactored extends BaseWindow
{
  ...
  protected void setupView()
  {
    ...
    GL11.glMaterial(GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,
        allocFloats(new float[]
        { 0, 0.8f, 0, 1 }));

    GL11.glMaterial(GL11.GL_FRONT, GL11.GL_SPECULAR, allocFloats(new float[]
    { 122, 123, 332, 655 }));
    GL11.glMaterialf(GL11.GL_FRONT, GL11.GL_SHININESS, 225f);
  ...
  protected void renderFrame()
  {
    ...
    m_pUser3.setPosition(posX + 1, posY + 1, posZ);
